...
var indexedDB = indexeddbjs.indexedDB('sqlite3', engine);
...
function CitySDK() {
    ...
    //    if (!_.contains(CitySDK.prototype.CitySDKdb.objectStoreNames, "citySDKCache")) {
 ...
 */
CitySDK.prototype.jsonpRequest = function (url, fn) {
